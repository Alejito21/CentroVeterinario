...
class CentroVeterinarioTest {
    ...
    void agregarMascota() {
        ...
        Mascota mascota = new Mascota("Firulais", "Labrador", 3, "M001", Especie.PERRO, propietario, consulta);
    ...
    void verificarMascota() {
        ...
        Mascota mascota = new Mascota("Mimi", "Siames", 2, "M002", Especie.GATO, propietario, consulta);
    ...
    void eliminarMacota() {
        ...
        Mascota mascota = new Mascota("Rocky", "Bulldog", 4, "M003", Especie.PERRO, propietario, consulta);
        centro.agregarMascota(mascota);
